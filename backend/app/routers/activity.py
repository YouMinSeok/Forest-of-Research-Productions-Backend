    ...
    try:
        ...
        for post in recent_posts:
            ...
            activity = {
                ...
                "id": str(post["_id"])  # navigateToPost에서 사용하는 id 필드 추가
            }
                ...
                if post:
                    ...
                    if post.get("is_private", False):
                        if not user or user["id"] != post.get("writer_id"):
                            ...
                            post_title = "🔒 비공개 게시글입니다"
                            post_prefix = ""
                            # 댓글 작성자도 비공개로 처리 (비공개 게시글의 댓글이므로)
